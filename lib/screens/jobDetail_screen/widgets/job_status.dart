    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text("5 Member",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
          ...
          Text("40k Likes",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
          Container(height: 40,width: 2,color:Colors.black26),
          Flexible(child: Icon(Icons.location_on_outlined,color: Colors.deepOrange,)),
          Text("Yogyakarta",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
